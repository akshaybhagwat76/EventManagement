...
namespace MiidWeb
{
    public partial class IveriError : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string text = String.Format(@"Iveri Error Page Loaded {0} - Status {1} Description - {2} transaction type - {3} - reference {4}
