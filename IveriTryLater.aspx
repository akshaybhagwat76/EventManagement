<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IveriTryLater.aspx.cs" Inherits="MiidWeb.IveriTryLater" %>
<!DOCTYPE html>
<!--
...
<body>
  <div class="header_banner_conainer">
    <a href="https://www.miid.co.za"><img src="../../content/images/logo_dark.svg" alt="" class="logo" /></a></div>
  <!-- Header -->
  <section id="header">
    <header>
      <span class="logo">
                ...
                <form name="Form1" method="post" id="Form1" runat="server">
                    ...
                    <div class="form_container">
                        ...
                        <asp:Panel runat="server" ID="pnlSuccess">
                            <div class="register_text">Your transaction was successful.</div>
                    ...
                    <asp:Label runat="server" ID="lblmerchantReference" />
                        ...
                        <asp:Panel runat="server" ID="pnlFailed">
    ...
    <!-- Footer -->
      <section id="footer">
        <div class="container">
          ...
          <ul class="copyright">
            <li>
              MiiD online ticketing & cashless solutions & payments  |
