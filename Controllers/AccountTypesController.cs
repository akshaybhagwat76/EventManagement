...
namespace MiidWeb.Controllers
{
    ...
    public class AccountTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Code,Description,Context")] AccountType accountType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Code,Description,Context")] AccountType accountType)
        {
            if (ModelState.IsValid)
            {
