...
namespace MiidWeb.Controllers
{
    ...
    public class StaffTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Code,Description")] StaffType staffType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Code,Description")] StaffType staffType)
        {
            if (ModelState.IsValid)
            {
