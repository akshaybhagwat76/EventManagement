...
namespace MiidWeb
{
    public partial class IveriTryLater : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string text = String.Format(@"Iveri try later Page Loaded {0} - Status {1} Description - {2} transaction type - {3} - reference {4}
            ...
            if (status == "0")
            {
                ...
                if (bt != null)
                {
                    ...
                    {
                        //Add Miifunds record
                        MyMoneyRepository.SuccessfulTopup(bt.EndUserID, (decimal)intAmount, merchantReference, String.Format("Card Payment Topup #{0}", merchantReference));
