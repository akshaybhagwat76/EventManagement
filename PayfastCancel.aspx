<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayfastCancel.aspx.cs" Inherits="MiidWeb.PayfastCancel" %>
    ...
    <div class="collapse navbar-collapse">
        ...
        <div class="row vertical-offset-40px">
            ...
            <div class="col-md-8 col-md-offset-2">
              ...
              <br><br>
               <i class="fa fa-times fa-5x" aria-hidden="true" style="color:#be1c1d"></i>
               <br><br>
              

               <a href="../Home/Index" class="btn btn-lg btn-default btn-block">Continue</a>
